...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $query = "INSERT INTO `popular_tag`(`name`, `link`, `is_active`, `is_delete`, `is_draft`) VALUES ('$name', '$link ', '$tag_activate', '$delete_tag', '$draft_tag') ";
...
<div class="col-10">
  ...
  <div class="card">
    <div class="card-header">
      <h4 class="float-left">Create Popular Tag</h4>
