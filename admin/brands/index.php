      ...
      <div class="col-10">
        ...
        <div class="card">
          <div class="card-header">
            <h4 class="float-left">Brands List</h4>
            <a href="create.php" class="btn btn-primary float-right">Create Brand</a>
          </div>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
                  ...
                  <th scope="col">Activate Brand</th>
                  <th scope="col">Draft Brand</th>
