...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
  ...
  $query = "INSERT INTO `sponsores`(`title`, `picture`, `link`, `promotional_message`, `html_banner`, `is_active`, `is_draft`) VALUES ('$title', '$uploaded_name ', '$link', '$msg', '$html_banner', '$banner_activate', '$draft_banner ') ";
