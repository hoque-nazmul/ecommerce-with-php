...
$showProducts = $_product->GetBrandShoesProduct();
$products = $_product->GetBrandLadyProduct();
$newProducts = $_product->GetBrandTechProduct();


?>

<div class="container-fluid img-overlay top-img">
	<p class="text-center text-black"><a href="index.php">Home/Top Brands</a></p>
</div>
...
<div class="hello bg-white pb-5">
	...
	<div class="container-fluid mt-5">
		<div class="row">
			...
			<?php if (count($showProducts) > 0) { ?>
				<?php foreach ($showProducts as $showProduct) : ?>
					<div class="col-md-3 card-dance">
						<div class="card custom-card">
							<div class="inner">
								<a href="preview.php?id=<?= $showProduct['id'] ?>"><img src="<?php echo $webroot ?>uploads/product/<?= $showProduct['picture'] ?>" alt="card-1" class="card-img-top"></a>
							</div>
							<div class="card-body">
								<h2><?= $showProduct['title'] ?></h2>
								<p><?= $showProduct['short_description'] ?></p>
								<p><span class="price">$<?= $showProduct['cost'] ?></span></p>
								<a href="preview.php?id=<?= $showProduct['id'] ?>" class="btn btn-success pl-4 pr-4">Details</a>
							</div>
						</div>
					</div>
				<?php endforeach; ?>
...
<div class="hello bg-light-gray pb-5 mt-5">
	<div class="container-fluid pt-5">
		...
		<div class="row">
			<h3 class="ml-4">SMART LADIES DRESS</h3>
		</div>
		<div class="row">
			<div class="underline ml-4"></div>
		</div>
...
<div class="hello bg-white pb-5">
	<div class="container-fluid pt-5">
		...
		<div class="row">
			<h3 class="ml-4">LATEST TECHNOLOGY ITEM</h3>
		</div>
		<div class="row">
			<div class="underline ml-4"></div>
		</div>
